...
const GroupSearch = forwardRef(({ groupSearch, username, fetchUserData, BACKEND_URL }, ref) => {
  ...
  return (
    <article className="flex items-center gap-3 p-2 transition hover:opacity-65 w-full">
        <img src={groupSearch.picture} alt="picture-group" className="xl:w-16 xl:h-16 w-10 h-10 rounded-full object-cover" onError={e => e.target.src = '/picture-group-no-load.png'}/>
